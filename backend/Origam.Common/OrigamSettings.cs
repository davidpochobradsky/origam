...
namespace Origam
{
	...
	public class OrigamSettings : ICloneable
	{
		...
		[Category("Model Connection")]
		[Browsable(false)]
		public string SchemaDataService { get; set; } = "Origam.DA.Service.MsSqlDataService, Origam.DA.Service";

		[Category("Data Connection")]
		public string DataDataService { get; set; } = "Origam.DA.Service.MsSqlDataService, Origam.DA.Service";
